...
def create_student_course_endpoint(
    ...
    student_course_data: StudentCourseCreate = None,
    session=Depends(get_session),
):
    """学生选课"""
    return StudentCourseService.create_student_course(current_user, student_course_data, session)
...
def get_student_courses_endpoint(
    ...
    """获取学生的选课列表"""
    return StudentCourseService.get_student_courses(current_user, student_id, session)
...
def get_course_students_endpoint(
    ...
    """获取课程的学生列表"""
    return StudentCourseService.get_course_students(current_user, course_id, session)
...
def get_similar_course_students_endpoint(
    ...
    return StudentCourseService.get_similar_course_students(current_user, teacher_id, course_id, session)
...
def delete_student_course_endpoint(
    ...
    """学生退课"""
    return StudentCourseService.delete_student_course(current_user, student_id, course_id, session)